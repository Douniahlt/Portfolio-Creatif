...
function initLab() {
    ...
    // Solution hybride : une vidéo YouTube et une vidéo locale
    labDisplay.innerHTML = `
<canvas id="gl4d-canvas"></canvas>

<!-- Première démo : vidéo YouTube -->
<div id="demo-video-1" class="demo-video hidden">
    <iframe width="100%" height="100%" 
        src="about:blank" 
        data-src="https://youtu.be/epXMVJcsTxc" 
        title="Démo 1" 
        frameborder="0" 
...
`;
    ...
    function updateCauldron() {
        ...
        if (selectedIngredients.length === 1) {
            ...
            cauldron.style.background = `linear-gradient(to right, ${colors[selectedIngredients[0]]}, ${colors[selectedIngredients[1]]
                })`;
        } else {
            cauldron.style.background = `linear-gradient(to right, ${colors[selectedIngredients[0]]}, ${colors[selectedIngredients[1]]}, ${colors[selectedIngredients[2]]
                })`;
        }
